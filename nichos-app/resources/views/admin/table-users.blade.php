<h1 class="text-center text-4xl font-bold">Usuarios</h1>
<!-- component -->
                    ...
                    <tr class="text-gray-700">
                            ...
                            <div class="flex items-center text-sm">
                                <div class="relative w-8 h-8 mr-3 rounded-full md:block">
                                    ...
                                    <img class="object-cover w-full h-full rounded-full"
                                         src="https://images.pexels.com/photos/5212324/pexels-photo-5212324.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" alt="" loading="lazy" />
                                    -->
                                </div>
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600">{{ $user->nombre_rol }}</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex flex-row">
                                <a href="{{ route('edit.user', ['id' => $user->id_usuario]) }}" class="">
                                ...
                                @if($user->estado == 0)
                                    <a onclick="return confirm('¿Desea activar al usuario?');"
                                ...
                                @else
                                    <a  onclick="return confirm('¿Desea suspender al usuario?')"
