...
<h1 class="text-center text-4xl font-bold">Nichos ocupados</h1>
<!-- component -->
<div class="container mx-auto p-4 font-mono">
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">

        @if($usuario->rol_id == \App\enums\TipoRol::ENCARGADO)
            <div class="flex flex-row gap-4 items-start p-2">
                <form class="flex flex-row items-end gap-2"
                      method="get"
                      action="{{ route('nicho.porCodigo') }}">
                    @csrf
                    <input type="hidden" value="{{ \App\enums\EstadoNicho::OCUPADO }}" name="estado">
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600">{{ $nicho->procedencia }}</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex flex-row">
                                ...
                                @endif
                                <a href="{{ route('foto.nicho', ['id' => $nicho->codigo]) }}"
                                   title="Ver fotos"
                                   class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor" class="size-6 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105">
                                        <path stroke-linecap="round" stroke-linejoin="round"
