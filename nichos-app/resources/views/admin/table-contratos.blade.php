                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex flex-row">
                               ...
                               @if($contrato->estado == \App\enums\TipoContrato::SOLICITADO)
                                    <a onclick="return confirm('¿Desea aprobar el contrato?')"
                                       title="Aprobar solicitud"
                                       class="p-2"
                                       href="{{ route('actualizar.contrato', ['id' => $contrato->id_contrato,'estado' => \App\enums\TipoBoleta::APROBADO]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <a onclick="return confirm('¿Desea rechazar el contrato?');"
                                       title="Rechazar solicitud"
                                       class="p-2"
                                       href="{{ route('actualizar.contrato', ['id' => $contrato->id_contrato, 'estado' => \App\enums\TipoBoleta::RECHAZADO]) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
