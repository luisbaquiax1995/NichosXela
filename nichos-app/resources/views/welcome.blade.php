...
<nav x-data="{ mobileMenuOpen: false, productMenuOpen: false, mobileProductMenuOpen: false }"
                ...
                <div class="p-4">
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        ...
                        <div class="flex-auto">
                            ...
                            <p class="mt-1 text-gray-600">Gestiona a los usuarios</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="p-4">
                    ...
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        <div
                            class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <img src="{{ asset('img/nichos.svg') }}" alt="nichos">
                        </div>
                        <div class="flex-auto">
                            <a href="#" class="block font-semibold text-gray-900">
                                Nichos disponibles
                    ...
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        <div
                            class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <img src="{{ asset('img/nichos2.svg') }}" alt="nichos">
                        </div>
                        <div class="flex-auto">
                            <a href="#" class="block font-semibold text-gray-900">
                                Nichos ocupados
            ...
            >
                <div class="p-4">
                    ...
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        ...
                        <div class="flex-auto">
                            <a href="#" class="block font-semibold text-gray-900">
                                Solicitud de boletas
                                <span class="absolute inset-0"></span>
                            </a>
                            <p class="mt-1 text-gray-600">Lista de solicitudes de boletas</p>
                        </div>
                    </div>
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        <div
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="{{ route('user.logout') }}" class="text-sm font-semibold text-gray-900">Salir <span aria-hidden="true">&rarr;</span></a>
    </div>
        ...
        <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
                <div class="space-y-2 py-6">
                    ...
                    <!-- Otros enlaces -->
                    <a href="#"
                       class="block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Features</a>
                    <a href="#"
                       class="block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Marketplace</a>
                    <a href="#"
                       class="block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Company</a>
                </div>
