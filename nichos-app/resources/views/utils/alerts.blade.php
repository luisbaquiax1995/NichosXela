                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            <p class="text-sm font-medium text-gray-900">Operación stisfactora</p>
                            <p class="mt-1 text-sm text-gray-500">{{ session('msg-success') }}</p>
                        </div>
            ...
            <div
                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            <p class="text-sm font-medium text-gray-900">Operación stisfactora</p>
                            <p class="mt-1 text-sm text-gray-500">{{ $msg_ok }}</p>
                        </div>
                        <div class="ml-4 flex flex-shrink-0">
                            <button type="button"
                                    class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            ...
            <div class="pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            <p class="text-sm font-medium text-gray-900">Algo salio mal, lo sentimos</p>
                            <p class="mt-1 text-sm text-gray-500">{{ session('msg-error') }}</p>
                        </div>
                        <div class="ml-4 flex flex-shrink-0">
