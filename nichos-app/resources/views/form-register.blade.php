...
<form class="shadow-md p-6 rounded-xl"
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        @if(!$editing)
            <a class="transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" href="/">Iniciar
                sesión</a>
            ...
            <button type="submit"
                    class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600
                        transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-100">Registrarme
            </button>
        @else
