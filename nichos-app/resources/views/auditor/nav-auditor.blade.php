            ...
            >
                <div class="p-4">
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        ...
                        <div class="flex-auto">
                            <a href="{{ route('historico.contratos') }}"
                               class="block font-semibold text-gray-900">
                                Historial de contratos
                                <span class="absolute inset-0"></span>
                            </a>
                            <p class="mt-1 text-gray-600">Revisa el historial de contratos y nichos</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4">
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        ...
                        <form action="{{ route('contratos.getByEstado') }}" method="get">
                            @csrf
                            <input type="hidden" value="auditor" name="auditor">
                            <input type="hidden" value="{{ \App\enums\TipoContrato::A_PUNTO_DE_VENCER }}" name="estado">
                            ...
                            <div class="flex-auto">
                                ...
                                <p class="mt-1 text-gray-600">Revisa los contratos</p>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            >
                <div class="p-4">
                    ...
                    <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                        ...
                        <div class="flex-auto">
                            <a href="{{ route('pendintes.pago') }}" class="block font-semibold text-gray-900">
                                Pagos pendientes
                                <span class="absolute inset-0"></span>
                            </a>
                            <p class="mt-1 text-gray-600">Verifica las boletas pendientes</p>
                        </div>
                    </div>
                </div>
            </div>
